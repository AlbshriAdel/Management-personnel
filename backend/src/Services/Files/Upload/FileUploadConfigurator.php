...
class FileUploadConfigurator
{
    ...
    public const SCIENTIFIC_PAPERS_FILES_ID = "a1b2c3d4e5f6scientificpapers789";
    ...
    public function getConfiguration(string $configurationId): UploadConfigurationDTO
    {
        $configuration =  match ($configurationId) {
            ...
            self::SCIENTIFIC_PAPERS_FILES_ID  => $this->buildScientificPapersFilesConfig(),
     ...
     * @return UploadConfigurationDTO
     */
    private function buildScientificPapersFilesConfig(): UploadConfigurationDTO
    {
        return new UploadConfigurationDTO(
            identifier: self::SCIENTIFIC_PAPERS_FILES_ID,
            maxFileSizeMb: 50,
            multiUpload: true,
            allowNaming: true,
            source: UploadedFileSourceEnum::SCIENTIFIC_PAPERS->value,
            uploadDir: null,
            allowTagging: false
        );
    }
