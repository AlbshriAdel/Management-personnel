...
export default class UserModuleRights {
    ...
    public static readonly CAN_ACCESS_SCIENTIFIC_PAPERS_MODULE: string = 'CAN_ACCESS_SCIENTIFIC_PAPERS_MODULE';
    ...
    public static readonly MODULE_ACCESS_RIGHTS = {
        ...
        [BackendModuleNameEnum.scientificPapers]: UserModuleRights.CAN_ACCESS_SCIENTIFIC_PAPERS_MODULE,
    };
}